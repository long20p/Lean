...
{
    public class TiingoMinuteFeedAlgorithm : QCAlgorithm
    {
        private static readonly string[] DefaultTickers = new[] { "SPY" };
        ...
        public override void Initialize()
        {
            ...
            var insightPeriodMinutes = GetPositiveIntParameter(InsightPeriodParameterName, 2);
        ...
        private sealed class TiingoMomentumAlphaModel : AlphaModel
        {
            ...
            private sealed class SymbolState
            {
                ...
                public SymbolState(Symbol symbol, int fastPeriod, int slowPeriod, TimeSpan horizon)
                {
                    ...
                    // For minute data, throttle insights to once per minute minimum
                    var minSeconds = Math.Max(60, (int)Math.Round(horizon.TotalSeconds / 2.0));
